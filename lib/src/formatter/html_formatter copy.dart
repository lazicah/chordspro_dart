...
class HtmlFormatter extends Formatter implements FormatterInterface<String> {
  @override
  ...
  String getLyricsHtml(Lyrics lyrics) {
    ...
    for (var block in lyrics.blocks.asMap().entries) {
      ...
      if (lyrics.hasInlineChords) {
        ...
        line +=
            '<span class="chordpro-block"><span class="chordpro-chord" data-chord="$originalChord">$chord</span><span class="chordpro-text">$text</span></span>';
